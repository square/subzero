...
add_custom_command(OUTPUT plutus-signed.sar
  DEPENDS plutus
  COMMAND ${NFAST_PATH}/bin/tct2 --sign-and-pack --key=plutussigner --is-machine --machine-type=PowerPCELF --infile=plutus --outfile plutus-signed.sar
)

add_custom_command(OUTPUT plutus-userdata-signed.sar
  COMMAND echo dummy > dummy
  COMMAND ${NFAST_PATH}/bin/cpioc plutus.cpio dummy
  COMMAND ${NFAST_PATH}/bin/tct2 --sign-and-pack --key=plutusdatasigner --machine-key-ident=plutussigner --infile=plutus.cpio --outfile plutus-userdata-signed.sar
)

add_custom_target(run-signed
  DEPENDS plutus-signed.sar plutus-userdata-signed.sar
  COMMAND sudo ${NFAST_PATH}/bin/nopclearfail -c -a
  COMMAND sudo ${NFAST_PATH}/bin/see-stdioesock-serv --machine plutus-signed.sar --userdata-sar plutus-userdata-signed.sar
)
