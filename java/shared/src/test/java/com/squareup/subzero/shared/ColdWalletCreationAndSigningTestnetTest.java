...
public class ColdWalletCreationAndSigningTestnetTest {
  ...
  @Test public void deriveColdWalletAddress() throws Exception {
    ...
    assertEquals("tpubDA3BGtNJE3oVSasjxXKPfoLExCWY7KCM5yz8tEgibzgMZaRM2ooSWTW55yz7DVtQG94BVN7UYomtyiDqhRicv9atALtgzVtDQxTEVV2wjNs", pubKey1);
    assertEquals("tpubD9u3Ks8VxbDqYgaoUfDWnRYiDzjY8itE6VgJkGmbGzKxPkSbLoxhSH9PCkdEvBk35rqCEdu7fFpG6uf2Um5oCYoJ8NUJ1WggdP3kJ3S3VPY", pubKey2);
    assertEquals("tpubD8nQGcVLyQTQ4NxVhAYEvEtURo7B5PoTiGs1ez8vKHbVBQdz83hxmgvjRoZCxcHa9h6Y3HQhj6FWZCEZt1RkewU9i9rre2hh2KsYAdXehep", pubKey3);
    assertEquals("tpubDA5bnZgugrog8xwQwUTNGGRnSQZHSiqe1jGivpkZJC8PF2UcokJ5Xo5z8EvD4BwmzCHd2VisxzcUg7Hkaxyxf177dpVPtMW2E6n3ijsPgke", pubKey4);
    ...
    assertEquals("2MuvzgSMJ5N8nVcosVQxLXjCmNsUwiNyPVE", coldWalletAddress);
  ...
  @Test public void createSignTxRequest1() {
    ...
    assertEquals("ELOn0AkqVAowCiAhzJ0aLWmXJqGlQmbHZoM1LCI8xcbtRY/fFEhlCsoIHRAAGIDJ/j0iBRAAGMs+Eg4IwMHAFBABGgUQARi8IRIOCICDgSkQARoFEAEYvSEYAA==", signTxRequest);
