...
sudo livemedia-creator --logfile=/vagrant/livemedia-creator.log --make-iso --ks=/tmp/rhel7-livemedia.with_additional_packages.ks --resultdir="/tmp/build" --no-virt --project="CentOS" --releasever="7.7.1908" --volid="CentOS 7 (1908) + nCipher x86_64"
