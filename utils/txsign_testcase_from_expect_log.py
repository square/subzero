...
def generate_test_vectors_from_expect_log(logfile, out_dir):
  ...
  for i, (req, res) in enumerate(zip(requests, responses)):
    filePath = Path(out_dir) / "valid-{:0>4d}".format(i)
...
if __name__ == "__main__":
  ...
  generate_test_vectors_from_expect_log(logfile, out_dir)
